...
#define STRING_CONFIG_H_AUTHOR "(Cyberbond, Printy-Box)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Printy-Box"
...
#endif
  #define ENDSTOPPULLUP_ZMIN_PROBE //The detection signal is open-drain output, and a pull-up resistor needs to be set.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 190 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-37.5, 0, -1 }
