...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define PLR_BED_THRESHOLD 50 // (°C) Skip user confirmation at or above this bed temperature (0 to disable)
...
#define SAFE_BED_LEVELING_START_Y 0
#define SAFE_BED_LEVELING_START_Z 0
